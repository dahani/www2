...
abstract class BetterPlayerControlsState<T extends StatefulWidget> extends State<T> {
 ...
 void setVolune(double level) {
  betterPlayerController?.postEvent(
    BetterPlayerEvent(BetterPlayerEventType.customVolume,parameters: {'volume':level})
  );
}
 void setBrightness(double level) {
  betterPlayerController?.postEvent(
    BetterPlayerEvent(BetterPlayerEventType.customBrithness,parameters: {'br':level})
  );
}

  void skipForward() {
     betterPlayerController?.postEvent(
    BetterPlayerEvent(BetterPlayerEventType.customSkipNext)
  );
  }
  void showSpeed() {
