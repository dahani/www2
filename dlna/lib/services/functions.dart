...
void showLoading(String message,BuildContext context) {
  ...
  String getMovieVideoSrc(String url){
...
String formatRuntime(int minutes) {
  ...
  Widget buildslisTile({dynamic ch,required VoidCallback onClick,required VoidCallback onLongPress,required  DlnaService dlnaService,required VoidCallback setFavourite }) {
    return Container(
  ...
  Future<String> resolvePlayableUrl(String url,BuildContext context) async {
    if (!isYoutubeUrl(url)) {
      return url; // normal stream
    }
    final yt = YoutubeExplode();

    try {
      showLoading("Resolving stream...",context);
